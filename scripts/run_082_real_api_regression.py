"""Deprecated 0.8.2 real-provider harness; retained as a fail-closed tombstone.
...
raise SystemExit(
    "DEPRECATED: this 0.8.2 harness is disabled because it could read/copy desktop "
