...
[![Core / Web](https://img.shields.io/badge/Core%20%2F%20Web-0.8.2-C26C4A?style=flat-square)](CHANGELOG.md#082---2026-08-10)
[![Launcher](https://img.shields.io/badge/Launcher-0.8.2-6C9D8F?style=flat-square)](docs/LAUNCHER_ONBOARDING.md)
...
Mindspace 当前机器可读更新源记录了从 `0.4.4` 到 `0.8.2` 的 **66 个版本节点**。仓库不会为了补齐
...
| 0.8.x | V7 命格与 V2 角色卡、原生函数调用、角色工具链、桌面交互收敛与快速启动 |

<details>
<summary><strong>展开完整 63 个版本节点</strong></summary>

<!-- release-history:start -->
> 自动同步自 [docs/release-history.json](docs/release-history.json)，当前共 **66** 个版本节点。

#### 0.8.x

| 版本 | 日期 | 主题 | 状态 |
| --- | --- | --- | --- |
| [0.8.2](CHANGELOG.md#082---2026-08-10) | 2026-08-10 | 原生函数调用与角色工具链 | local_release |
| [0.8.1](CHANGELOG.md#081---2026-08-09) | 2026-08-09 | 命格 V7、V2 角色卡与自然成人表达 | 本地回归通过 |
