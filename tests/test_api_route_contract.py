...
EXPECTED_OPERATIONS = [
    ("/api/v1/activities", "get", "list_activities_api_v1_activities_get"),
    (
        "/api/v1/activities/{activity_id}/sessions",
        "post",
        "start_activity_api_v1_activities__activity_id__sessions_post",
    ),
    (
    ...
    ("/api/v1/character-drafts/{legacy_path}", "delete", "legacy_character_drafts_path_delete"),
    ("/api/v1/character-drafts/{legacy_path}", "get", "legacy_character_drafts_path_get"),
    ("/api/v1/character-drafts/{legacy_path}", "patch", "legacy_character_drafts_path_patch"),
    ("/api/v1/character-drafts/{legacy_path}", "post", "legacy_character_drafts_path_post"),
    ("/api/v1/character-drafts/{legacy_path}", "put", "legacy_character_drafts_path_put"),
    ...
    (
        "/api/v1/characters/{character_id}/history",
        "get",
        "character_history_api_v1_characters__character_id__history_get",
    ),
    ("/api/v1/characters/{character_id}/journal", "get", "list_journal_api_v1_characters__character_id__journal_get"),
    (
        "/api/v1/characters/{character_id}/journal",
        "post",
        "create_journal_api_v1_characters__character_id__journal_post",
    ),
    (
    ...
    (
        "/api/v1/characters/{character_id}/moments",
        "post",
        "create_moment_api_v1_characters__character_id__moments_post",
    ),
    (
    ...
    ("/api/v1/memory/events/{event_id}", "delete", "delete_event_memory_api_v1_memory_events__event_id__delete"),
    ("/api/v1/memory/events/{event_id}", "put", "update_event_memory_api_v1_memory_events__event_id__put"),
    (
...
def test_static_mount_contract_is_stable_after_route_split(tmp_path):
    ...
    mounts = {(route.path, route.name) for route in app.routes if route.__class__.__name__ == "Mount"}
    assert mounts == {
        ("/assets", "assets"),
