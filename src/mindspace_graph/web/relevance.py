...
_INTENT_WORDS = {
    "official", "account", "today", "post", "posts", "api", "update", "updates", "latest", "release", "releases", "recent", "news",
    "search", "find", "open", "github", "twitter", "reddit", "youtube", "bluesky", "mastodon", "repo", "repository",
    "官方", "最近", "一周", "发布", "更新", "搜索", "查找", "打开", "账号", "帖子", "仓库", "版本",
}
_KNOWN_ENTITIES = {
    "openai": ("openai",),
